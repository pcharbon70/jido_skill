...
- [x] Added `jido --skill routes [options]` CLI routing for terminal route inspection.
- [x] Explicit `jido --skill run <skill_name> ...` remains available for skill names that collide with subcommands (for example, `routes`).
